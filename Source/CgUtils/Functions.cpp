...
std::vector<glm::vec3> Functions::Lane_Riesenfeld_Unterteilungs_Algorithmus(std::vector<glm::vec3> verticesold, int n) {
    ...
    std::cout << "vertices nach dem doppeln:\n";
...
//    //2-4 Schritte sind ueblich!
    for (int j = 0; j < n; j++)
    {
        ...
        {
            vertices.at(i)[0] = (vertices.at(i)[0] + vertices.at(i)[0] ) / 2.0f;
            vertices.at(i)[1] = (vertices.at(i)[1] + vertices.at(i)[1] ) / 2.0f;
            vertices.at(i)[2] = (vertices.at(i)[2] + vertices.at(i)[2] ) / 2.0f;

            std::cout << "mitteln: " << vertices.at(i)[0] << " " << vertices.at(i)[1] << " " << vertices.at(i)[2] << std::endl;
        }
    ...
    std::cout << "vertices nach dem algorithmus:\n";
    for (int i = 0; i < vertices.size(); i++) {
        std::cout << i << ": "<< vertices.at(i)[0] << " " << vertices.at(i)[1] << " " << vertices.at(i)[2] << std::endl;
    }

//    std::cout << "verticesold:\n";
//    for (int i = 0; i < verticesold.size(); i++) {
//        std::cout << i << ": " << verticesold.at(i)[0] << " " << verticesold.at(i)[1] << " " << verticesold.at(i)[2] << std::endl;
//    }
    return vertices;
}
